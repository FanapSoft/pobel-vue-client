...
export default function (props) {
    ...
    if(fullscreen) {
        modalBg.classList.add('modalBg', 'modalFullscreen');
    } else {
    ...
    actionCounter.className = 'modalActionCounter';
