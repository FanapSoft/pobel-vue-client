 ...
 */
const ApiService = {
  //loginUrl: `http://10.56.16.50:8888/pod/authentication/callback?host=${(process.env.NODE_ENV === 'production' ? encodeURI('http://10.56.16.50') : encodeURI('http://localhost:8080') + "&local=true")}`,
